...
export default function LaunchYourAdsLiveLaunch() {
  ...
  const handleGenerateVideoScripts = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "3 video scripts created using your Build Your Strategy messaging",
      });
  ...
  const handleDownloadPDF = () => {
    ...
    [1, 2, 3].forEach((num) => {
      const script =
        generatedScripts[`script${num}` as "script1" | "script2" | "script3"];
    ...
    <div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-2">
              Create and launch effective advertising campaigns for your live
              launch funnel
            </p>
          </div>
      ...
      >
            ...
            <Card>
              ...
              <CardContent>
                <div className="prose max-w-none text-slate-700 leading-relaxed space-y-4">
                  <p>
                    Now that your live launch funnel is ready, it's time to
                    bring people in! In this step, you'll duplicate your funnel
                    for ads, choose your ad targeting, create your ad creative
                    and set up your live launch campaigns to start running 10–14
                    days before your event kicks off.
                  </p>
                  <p>
                    The goal here is to get consistent registrations (both warm
                    & cold traffic) so you have an engaged audience showing up
                    live and primed to buy your core offer when the sales promo
                    starts.
                  </p>
                  <p>
                    By the end of this section, you'll have ads running that
                    fill your live launch with quality leads and you'll be in
                    your promo period for your live launch emailing your list
              ...
              <CardContent>
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-600">
                    Allow a few days to duplicate your funnel, create and upload
                    ad assets, and get your campaign approved by the ad
                    platform.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    {
                      title: "Plan for runway",
                      text: "Start ads 10–14 days before your live launch event to give enough time for registrations to come in.",
                    },
                    {
                      title: "Target strategically",
                      text: "Use your messaging strategy to guide which interests, lookalikes, or audiences to start with.",
                    },
                    {
                      title: "Talk about your event everywhere",
                      text: "While you're running ads you'll also want to be sending out your emails to your list inviting them to the experience, posting on social media and even talking to any leads you've had conversations with in the past. The goal being as many quality registrations as possible!",
                    },
                    {
                      title: "Test Everything",
                      text: "Make sure your pixel is firing and you can clearly see registrations inside Ads Manager and your CRM.",
                    },
                    {
                      title: "Remember the goal",
                      text: "It's not about the cheapest clicks — it's about filling your launch with the right leads who are excited for your event. Use our team support calls to feel fully informed around your data!",
                    },
                  ].map((tip, index) => (
                    <div key={index} className="flex items-start gap-3">
            ...
            <CardContent>
              ...
              <Tabs defaultValue="funnel" className="space-y-4">
                <TabsList className="grid w-full grid-cols-4 gap-1">
                  ...
                  >
                    Duplicate Your Live Launch Funnel
                  </TabsTrigger>
                  <TabsTrigger
                    value="targeting"
                    className="text-xs md:text-sm px-2 md:px-4"
                  >
                    Live Launch Targeting
                  </TabsTrigger>
                  <TabsTrigger
                    value="setup"
                    className="text-xs md:text-sm px-2 md:px-4"
                  >
                    Setting Up Your Live Launch Ads
                  </TabsTrigger>
                  <TabsTrigger
                    value="promoting"
                    className="text-xs md:text-sm px-2 md:px-4"
                  >
                    Promoting Your Live Launch
                  </TabsTrigger>
                </TabsList>
        ...
        <TabsContent value="script-generator" className="space-y-6">
          ...
          {generatedScripts &&
            generatedScripts.script1 &&
            generatedScripts.script2 &&
            generatedScripts.script3 && (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        {isEditingScript1 ? (
                          <Button
                            size="sm"
                            className="bg-embodied-coral text-white hover:bg-coral-600"
                            onClick={() => handleSaveScript(1)}
                          >
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingScript3 ? (
                          <Input
                            ...
                            onChange={(e) =>
                              setEditedScript3Title(e.target.value)
                            }
                            className="font-semibold"
                          />
                        ) : (
                          <CardTitle>
                            {generatedScripts.script3.title}
                          </CardTitle>
                        )}
                      </div>
                      <div className="flex gap-2">
                  ...
                  <CardContent className="pt-6">
                    {isEditingScript3 ? (
                      <Textarea
                        ...
                        onChange={(e) =>
                          setEditedScript3Content(e.target.value)
                        }
                        rows={15}
                        className="font-mono text-sm"
                      />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Generate professional video scripts for your live launch ads
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="prose max-w-none text-slate-700 leading-relaxed">
                <p>
                  Our AI-powered script generator will analyze your live launch
                  landing page and create compelling video scripts tailored to
                  your offer and audience.
                </p>
                <p>
                  Provide your landing page URL and we'll generate multiple
                  script variations for you to choose from.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Scripts will be generated using messaging from your Build
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <p className="text-slate-700">
                Walk through these steps one at a time to get your live launch
                ads officially launched!
              </p>
              ...
              <div className="grid gap-4">
                          ...
                          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                            ...
                            <div className="space-y-3 text-sm">
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <span className="text-slate-700">
                                  Keep energy high and authentic—people buy
                                  energy!
                                </span>
                              </div>
                            </div>
                ...
                {/* Step 2 */}
                <Collapsible
                  open={expandedSections.adCopy}
                  onOpenChange={() => handleSectionExpand("adCopy")}
                >
                  <Card
                    className={`border-2 transition-colors ${
                      completedSections.adCopy
                        ? "border-green-200 bg-green-50"
                        : "border-slate-200"
                    }`}
                  >
                      ...
                      <CardHeader className="hover:bg-slate-50 cursor-pointer">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <h3 className="font-semibold text-slate-900 text-left">
                              Double-Check Your Funnel Tracking & Pixel
                            </h3>
                          </div>
                ...
                >
                  ...
                  >
                    ...
                    <CollapsibleContent>
                      <CardContent className="pt-0">
                        <p className="text-slate-600">
                          Reference our step by step training video to set up
                          your campaign inside ads manager. Take your ad copy,
                          creative, and targeting and launch your first ads!
                        </p>
                      </CardContent>
                    </CollapsibleContent>
                  </Card>
                ...
                >
                  ...
                  >
                    ...
                    <CollapsibleContent>
                      <CardContent className="pt-0">
                        <p className="text-slate-600">
                          Run through your funnel to make sure it's working
                          properly. Click on your ad, go through your funnel,
                          and make sure everything is working as expected before
                          you launch.
                        </p>
                      </CardContent>
                    </CollapsibleContent>
                ...
                {/* Step 8 */}
                <Collapsible
                  open={expandedSections.invitation}
                  onOpenChange={() => handleSectionExpand("invitation")}
                >
                  <Card
                    className={`border-2 transition-colors ${
                      completedSections.invitation
                        ? "border-green-200 bg-green-50"
                        : "border-slate-200"
                    }`}
                  >
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <Checkbox
                              ...
                              onCheckedChange={() =>
                                handleSectionComplete("invitation")
                              }
                              onClick={(e) => e.stopPropagation()}
                    ...
                    <CollapsibleContent>
                      <CardContent className="pt-0">
                        <div className="space-y-4">
                          <p className="text-slate-600">
                            Start sending our your launch invite emails to your
                            email list and posting on your social media. While
                            your registration ads run you want to be talking
                            about and inviting people everywhere it makes sense
                            to sign up for this experience! Make sure everything
                            is cohesive in your marketing.
                          </p>
                        </div>
                      </CardContent>
                    </CollapsibleContent>
