...
export default function LaunchYourAds() {
  ...
  useEffect(() => {
    const loadCheckboxState = async () => {
      ...
      try {
        const response = await fetch('/api/implementation-checkboxes/launch-your-ads', {
          credentials: 'include'
        });
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      try {
        ...
        console.error('Failed to auto-save video script generator state:', error);
      }
    }, 1000); // Debounce for 1 second

    return () => clearTimeout(timeoutId);
  }, [inputMethod, landingPageUrl, landingPageContent, userId, isLoadingState, generatedScripts]);
  ...
  const handleGenerateVideoScripts = async () => {
    ...
    if (inputMethod === "manual") {
      if (!landingPageContent.trim() || landingPageContent.trim().length < 100) {
        toast({
          title: "Content Required",
          description: "Please paste your landing page content (at least 100 characters)",
          variant: "destructive"
        });
        return;
      }
    ...
    try {
      const response = await apiRequest("POST", "/api/generate-video-scripts", {
        manualContent: inputMethod === "manual" ? landingPageContent : undefined,
  ...
  const handleExportPDF = () => {
    ...
    const script1ContentLines = pdf.splitTextToSize(generatedScripts.script1.content, maxWidth);
    ...
    const script2ContentLines = pdf.splitTextToSize(generatedScripts.script2.content, maxWidth);
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-2">Create and launch effective advertising campaigns for your lead generation funnel</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="prose max-w-none text-slate-700 leading-relaxed space-y-4">
                  <p>
                    Now that your funnel is live, it's time to send traffic to it! In this step, you'll create your ad assets, set up your campaign, and launch. Using our trainings, guidance and even our team to do your ad copy & creative, you'll have everything you need to launch confidently!
                  </p>
                  <p>
                    By the end of this section, you'll have ads running to your lead gen funnel and can begin the optimization process!
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center">
                  <p className="text-2xl font-bold text-purple-600 mb-2">3–7 Days</p>
                  <p className="text-sm text-slate-600">
                    Depending on your pace and if you hit any roadblocks setting up your ads, which we will help with!
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { title: "Keep it simple", text: "One campaign, one audience, one ad set to start. Don't overcomplicate. You can expand on this quickly with our support." },
                    { title: "Leverage our team", text: "For both support and creating your ad copy & creative! Tech can get overwhelming and we've got you!" },
                    { title: "Test the basics", text: "Confirm your pixel fires, links work, and leads are landing in your CRM." },
                    { title: "Reference your strategy", text: "We created a budget for you in the initial strategy plan!" },
                    { title: "Don't chase perfection", text: "Get your ads live, then optimize based on data (CTR, CPC, opt-in rate)." },
                    { title: "Remember", text: "Launching is the win. You'll learn more from ads running than from planning." }
                  ].map((tip, index) => (
                    <div key={index} className="flex items-start gap-3">
            ...
            <CardContent>
              ...
              <Tabs defaultValue="funnel" className="space-y-4">
                <TabsList className="grid w-full grid-cols-4 gap-1">
                  <TabsTrigger value="funnel" className="text-xs md:text-sm px-2 md:px-4">Duplicate Your Funnel</TabsTrigger>
                  <TabsTrigger value="pixel" className="text-xs md:text-sm px-2 md:px-4">Placing Your Pixel</TabsTrigger>
                  <TabsTrigger value="targeting" className="text-xs md:text-sm px-2 md:px-4">Lead Gen Targeting</TabsTrigger>
                  <TabsTrigger value="setup" className="text-xs md:text-sm px-2 md:px-4">Setting Up Your Lead Gen Ads</TabsTrigger>
                </TabsList>

                <TabsContent value="funnel" className="space-y-6">
                  <div className="space-y-6">
                    <h3 className="text-xl font-semibold text-slate-900">Duplicate Your Funnel</h3>
        ...
        <TabsContent value="script-generator" className="space-y-6">
          ...
          {generatedScripts && (
            <div ref={generatedScriptsRef} className="space-y-6">
              ...
              <div className="space-y-6">
                  ...
                  <Card className="border-2 border-purple-200" data-testid="script-1">
                    <CardHeader className="pb-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Video className="w-5 h-5 text-purple-600" />
                          <CardTitle className="text-lg">SCRIPT 1 — Problem-Focused Hook</CardTitle>
                        </div>
                        {!isEditingScript1 ? (
                          <Button 
                            size="sm" 
                    ...
                    <CardContent className="space-y-4">
                      {!isEditingScript1 ? (
                        <>
                          <div>
                            <span className="font-bold text-slate-900">Title/Angle: </span>
                            <span className="text-slate-700 italic">"{generatedScripts.script1.title}"</span>
                          </div>
                        ...
                        <>
                          <div className="space-y-2">
                            <Label htmlFor="script1-title" className="text-sm font-medium text-slate-700">
                              Title/Angle
                            </Label>
                            <Input
                              id="script1-title"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="script1-content" className="text-sm font-medium text-slate-700">
                              Script Content
                            </Label>
                            <Textarea
                              id="script1-content"
                  ...
                  <Card className="border-2 border-blue-200" data-testid="script-2">
                    <CardHeader className="pb-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Video className="w-5 h-5 text-blue-600" />
                          <CardTitle className="text-lg">SCRIPT 2 — Desire/Curiosity-Focused Hook</CardTitle>
                        </div>
                        {!isEditingScript2 ? (
                          <Button 
                            size="sm" 
                    ...
                    <CardContent className="space-y-4">
                      {!isEditingScript2 ? (
                        <>
                          <div>
                            <span className="font-bold text-slate-900">Title/Angle: </span>
                            <span className="text-slate-700 italic">"{generatedScripts.script2.title}"</span>
                          </div>
                          <div className="leading-relaxed">
                        ...
                        <>
                          <div className="space-y-2">
                            <Label htmlFor="script2-title" className="text-sm font-medium text-slate-700">
                              Title/Angle
                            </Label>
                            <Input
                              id="script2-title"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="script2-content" className="text-sm font-medium text-slate-700">
                              Script Content
                            </Label>
                            <Textarea
                              id="script2-content"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate professional video scripts for your lead generation ads</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="prose max-w-none text-slate-700 leading-relaxed">
                <p>
                  Our AI-powered script generator will analyze your landing page and create compelling video scripts tailored to your offer and audience. 
                </p>
                <p>
                  Provide your landing page content via URL or manual entry and we'll generate two script variations for you to choose from.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup 
                  value={inputMethod} 
                  onValueChange={(value: "manual" | "url") => setInputMethod(value)}
                  className="flex gap-6"
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="manual" id="manual" data-testid="radio-manual-input" />
                    <Label htmlFor="manual" className="font-normal cursor-pointer">Manual Content</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="url" id="url" data-testid="radio-url-input" />
                    <Label htmlFor="url" className="font-normal cursor-pointer">Landing Page URL</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              {inputMethod === "manual" && (
                <div>
                  <Label htmlFor="landing-page-content" className="text-sm font-medium text-slate-700 mb-2 block">
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Copy and paste the text content from your landing page (headlines, benefits, features, offer details, etc.)
                  </p>
                </div>
              )}
                ...
                <div>
                  ...
                  <Alert className="mt-3">
                    <AlertDescription className="text-sm">
                      <strong>Note:</strong> URL extraction works best with traditional server-rendered pages. If your page is built with React, Vue, or similar frameworks, please switch to "Manual Content" and copy-paste your page text instead.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
              ...
              <div className="flex justify-center">
                <Button 
                  ...
                  disabled={isGeneratingScripts || (inputMethod === "manual" ? !landingPageContent.trim() : !landingPageUrl.trim())}
                  data-testid="button-generate-video-scripts"
                >
                  <FileText className="w-4 h-4 mr-2" />
                  {isGeneratingScripts ? "Generating Scripts..." : "Generate Video Scripts"}
                </Button>
              </div>
                ...
                <Card className="border-slate-200">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Audience-Targeted</h4>
                        <p className="text-sm text-slate-600">
                          Scripts are tailored to your specific audience and offer based on your landing page content
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-slate-200">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Multiple Variations</h4>
                        <p className="text-sm text-slate-600">
                          Get 3-5 different script approaches to test and find what resonates best
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-slate-200">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Proven Structure</h4>
                        <p className="text-sm text-slate-600">
                          Based on high-converting video ad frameworks that drive engagement and conversions
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-slate-200">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Platform Optimized</h4>
                        <p className="text-sm text-slate-600">
                          Scripts optimized for different platforms (Facebook, Instagram, YouTube, etc.)
                        </p>
                      </div>
                    </div>
                  </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <p className="text-slate-700">
                Walk through these steps one at a time to get your lead gen ads officially launched!
              </p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                            ...
                            <div className="space-y-3 text-sm">
                              ...
                              <div className="flex items-start gap-3">
                                <strong className="text-slate-900 min-w-[80px]">Delivery →</strong>
                                <span className="text-slate-700">If you mess up, pause and pick up where you left off (we'll edit).</span>
                              </div>
                              <div className="flex items-start gap-3">
                                <strong className="text-slate-900 min-w-[80px]">Energy →</strong>
                                <span className="text-slate-700">Smile, be expressive, and talk like you're speaking to a friend.</span>
                              </div>
                              <div className="flex items-start gap-3">
                                <strong className="text-slate-900 min-w-[80px]">Keep it short →</strong>
                                <span className="text-slate-700">Aim for 30–60 seconds max.</span>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <Collapsible open={expandedSections.automation} onOpenChange={() => handleSectionExpand('automation')}>
                  <Card className={`border-2 transition-colors ${completedSections.automation ? 'border-green-200 bg-green-50' : 'border-slate-200'}`}>
                      ...
                      <CardHeader className="hover:bg-slate-50 cursor-pointer">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <h3 className="font-semibold text-slate-900 text-left">Duplicate Your Funnel For Ads</h3>
                          </div>
                    ...
                    <CollapsibleContent>
                      <CardContent className="pt-0">
                        <p className="text-slate-600">
                          Watch our training video and make sure you have a duplicated funnel just for paid ads. This allows you to have 100% accurate tracking of your leads!
                        </p>
                      </CardContent>
                    </CollapsibleContent>
                  </Card>
                      ...
                      <CardHeader className="hover:bg-slate-50 cursor-pointer">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <h3 className="font-semibold text-slate-900 text-left">Place Your Pixel</h3>
                          </div>
