            ...
            {editingSection === section.id ? (
              ...
              >
                {sectionContent ? (
                  ...
                  <div className="text-slate-400 italic text-xs p-3 bg-slate-50 rounded border border-dashed border-slate-200">
...
export default function SalesPageGenerator({
  ...
  const {
    ...
    enabled: !!userId && offerNumber === 2, // Only fetch for offer 1
  });
  ...
  const generateSalesPageMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // Automatically set the new draft as current and display it
      ...
      toast({
        title: `New Sales Page Generated for Offer ${offerNumber}!`,
        description: `Draft ${offerDrafts.length + 1} is now displayed below.`,
      });
    },
    onError: (error) => {
      toast({
        title: `Offer ${offerNumber} Generation Failed`,
        description:
...
<body>
    <div class="container">
        ...
        <div class="section" style="text-align: center; margin-bottom: 40px;">
            ...
            <h2 style="font-size: 1.4rem; color: #4a5568; font-weight: normal; line-height: 1.4;">
  ...
  // Handle database loading states - don't block UI for missing optional data
  if (dataLoading) {
    return (
  ...
  // Only show error if messaging strategy fails to load (critical data)
  if (messagingError) {
    return (
  ...
  // Check if user has sufficient data for sales page generation - use same logic as Offer 1
  const hasMinimumData = (() => {
    const hasMessaging =
      messagingStrategy && Object.keys(messagingStrategy).length > 0;

    // For offer 2: Accept ANY available data source (matching Offer 1 behavior)
    ...
    <div className="space-y-6">
      {!generatedSalesPage ? (
        ...
        <div className="space-y-6">
          ...
          {/* Sales Page Generated Section - Matching Your Offer Sales Page */}
          <div className="border border-green-200 bg-green-50 rounded-lg p-4">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Button
                onClick={() => {
                  // Clear all drafts and generated content
                  setDrafts([]);
                  setCurrentDraftId(null);
                  setGeneratedSalesPage("");
                  setCompleteness(0);
          ...
          {/* Human Touch Required Section - Matching Your Offer Sales Page */}
          ...
          {/* Your Generated Sales Page Section - Matching Your Offer Sales Page */}
          <Card>
            ...
            <CardContent>
              {isEditing ? (
                ...
                <div className="space-y-4">
                  {/* Sales Page Actions section hidden as requested */}
